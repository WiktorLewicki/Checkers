...
/*
 * bot gra dobrze, g³êbokoœæ sprawdzanego grafu to 8
 * odpowiada zazwyczaj do 4 sekund, przy damach nie widzia³em ¿eby zwalnia³, aczkolwiek
 * napewno graf bêdzie du¿o wiêkszy
 * */
#include <iostream>
#include "silnik.cpp"
using namespace std;
